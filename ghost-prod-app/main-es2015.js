...
let VehicleViewComponent = class VehicleViewComponent {
    ...
    ngOnInit() {
        this.filteredSearchOptions = this.searchControl.valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(vehicle => this._filterSearch(vehicle)));
    }
    _filterSearch(vehicle) {
